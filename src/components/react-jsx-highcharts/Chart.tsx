...
import { HighchartsProvider, HighchartsChart } from 'react-jsx-highcharts';
import { Chart, XAxis, YAxis } from 'react-jsx-highcharts';
import { Title, Subtitle, Legend, LineSeries, Caption } from 'react-jsx-highcharts';

const ChartJSX: React.FC = () => {
    // https://whawker.github.io/react-jsx-highcharts/examples/SimpleLine/index.html
